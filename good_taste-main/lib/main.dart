// This file has been updated to add the AllergiesBloc provider
...
Future<void> testFirebaseConnection() async {
  try {
    ...
    DocumentReference docRef = await FirebaseFirestore.instance.collection('test_connection').add({
      'message': 'Test connection successful',
      'timestamp': FieldValue.serverTimestamp(),
    });
    
    print('✅ Firebase connection test successful! Document ID: ${docRef.id}');
