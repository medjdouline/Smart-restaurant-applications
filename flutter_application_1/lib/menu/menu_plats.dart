...
class MenuPlatsPage extends StatefulWidget {
  const MenuPlatsPage({Key? key}) : super(key: key);

  @override
  State<MenuPlatsPage> createState() => _MenuPlatsPageState();
}

class _MenuPlatsPageState extends State<MenuPlatsPage> {
  Item? _selectedPlat;
  ...
  Widget _buildContent(MenuService menuService, FavorisService favorisService) {
    ...
    final groupedPlats = menuService.groupedPlats;
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          for (var subCategory in groupedPlats.keys)
            Column(
                  ...
                  child: SizedBox(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        for (var plat in groupedPlats[subCategory]!)
                          Padding(
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              child: IconButton(
                icon: Icon(
                  _isFavorite(favorisService, plat.id) ? Icons.favorite : Icons.favorite_border,
                  color: _isFavorite(favorisService, plat.id) ? Colors.red : Colors.white,
                  size: 24,
                ),
                onPressed: () => _toggleFavorite(favorisService, plat),
              ),
            ),
            Positioned(
              bottom: 10,
                          ...
                          children: [
                            IconButton(
                              icon: Icon(
                                ...
                                color: _isFavorite(favorisService, _selectedPlat!.id) ? Colors.red : Colors.white,
                              ),
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(_selectedPlat!.description, textAlign: TextAlign.center, style: const TextStyle(fontSize: 16)),
                        ),
                        const SizedBox(height: 20),
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(vertical: 8),
                          child: Text(_selectedPlat!.ingredients, textAlign: TextAlign.center, style: const TextStyle(fontSize: 16)),
                        ),
                        const SizedBox(height: 20),
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            if (_currentRating > 0) {
                              ratingService.addRating(_selectedPlat!.id, _currentRating);
